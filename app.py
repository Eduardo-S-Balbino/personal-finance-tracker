...
def build_dashboard_api_data(current_user):
...
def create_app():
    ...
    @app.route("/api/mobile/demo-dashboard")
    @app.route("/api/mobile/demo-dashboard/")
    def api_mobile_demo_dashboard():
        demo_user = create_demo_account()
        dashboard_data = build_dashboard_api_data(demo_user)
    ...
    def api_dashboard():
        ...
        dashboard_data = build_dashboard_api_data(current_user)
        return jsonify(dashboard_data), 200
